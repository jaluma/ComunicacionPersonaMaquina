	...
	private JMenuBar getMenuBaR() {
		if (menuBar == null) {
			...
			mntmPlace.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					String value = (String)JOptionPane.showInputDialog(null, Internationalization.getString("select_place"), Internationalization.getString("select_place_title"), JOptionPane.DEFAULT_OPTION, new ImageIcon("/img/DE000.jng"), ListProduct.loadPlaces(), productListPanel.getComboBox().getSelectedIndex());
					if(value != null) {
			...
			mntmStars.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					String[] types = new String[] {Internationalization.getString("type_all_product"), Internationalization.getString("type_only_accom"), Internationalization.getString("type_only_packages"), Internationalization.getString("type_only_ticket")};
					
					String value = (String) JOptionPane.showInputDialog(null,Internationalization.getString("select_category"), Internationalization.getString("select_category_title"), JOptionPane.DEFAULT_OPTION, new ImageIcon("/img/DE000.jng"), types, 0);
					if (value != null) {
						int index = Arrays.asList(types).indexOf(value);
						int count = 0;
						for (Enumeration<AbstractButton> buttons = productListPanel.buttonGroup.getElements(); buttons.hasMoreElements();) {
			...
			mntmPeople.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					Object[] fields = new Object[] {Internationalization.getString("number_adult"),txNumberAdult, Internationalization.getString("number_child"),txNumberChild};
					
					JOptionPane.showConfirmDialog(MainWindow.this,  fields,Internationalization.getString("number_people_dialog"), JOptionPane.OK_CANCEL_OPTION);
			...
			mntmPrice.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {					
					...
					Object[] fields = new Object[] {Internationalization.getString("price_min_dialog"),txNumberAdult, Internationalization.getString("price_max_dialog"),txNumberChild};
